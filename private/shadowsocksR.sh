...
libsodium_url="https://github.com/letwen/scripts/raw/master/privatelibsodium-1.0.16.tar.gz"
shadowsocks_r_file="shadowsocksr-3.2.2"
shadowsocks_r_url="https://github.com/letwen/scripts/raw/master/privateshadowsocksr-3.2.2.tar.gz"
